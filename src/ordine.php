    ...
    <?php if(!empty($ordine)): ?>
        ...
        <div class="actions">
            <form action="conferma_ordine.php" method="post">
                <button type="submit" name="conferma" value="1">Conferma Ordine</button>
            </form>
        </div>
    <?php else: ?>
        <p>Non ci sono articoli nel tuo ordine. <a href="carrello.php">Trona al carrello</a> per aggiungere gli articoli.</p>
        <?php endif; ?>
</main>
</body>
</html>
